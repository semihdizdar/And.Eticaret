...
{
    public class Admin_OrdersController : AdminControllerBase
    {
        private AndDB db = new AndDB();

        // GET: Admin/Admin_Orders
        ...
        // GET: Admin/Admin_Orders/Details/5
        ...
        // POST: Admin/Admin_Orders/Create
        ...
        // POST: Admin/Admin_Orders/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Admin/Admin_Orders/Delete/5
        ...
        // POST: Admin/Admin_Orders/Delete/5
