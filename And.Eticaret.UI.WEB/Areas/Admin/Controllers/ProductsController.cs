...
namespace And.Eticaret.UI.WEB.Areas.Admin.Controllers
{
    public class ProductsController : AdminControllerBase
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,CategoryID,Brand,Model,ImageUrl,Description,Price,Discount,Tax,Stock,IsActive,CreateDate,CreateUserID,UpdateDate,UpdateUserID")] Product product)
        {
            if (ModelState.IsValid)
            {
